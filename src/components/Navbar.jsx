            ...
            >
                ...
                <div className="flex-grow overflow-y-auto py-4">
                    <nav className="space-y-1 px-4">
                        <Link to={`/dashboard/${role || 'patient'}`} onClick={(e) => handleProtectedAction(e, `/dashboard/${role || 'patient'}`)} className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-[#E1F5FE] hover:text-[#01579B] rounded-xl font-medium transition-colors">
